<footer class="container-fluid c-footer c-footer--gocareer" id="go-footer">
    <div class="container u-font-14">
        <div class="row u-text-align__center--mobile">
            <div class="col-12 col-lg-3">
                <a href="/">
                    <div class="icon">
                        <img src="{{ asset('images/logo-fap-agri-white.png') }}" alt="Fap-agri career logo">
                    </div>
                </a>
            </div>
            ...
            <div class="col-12 col-lg">
                <div class="row">
                    <a href="{{ route('job-list') }}" class="col-12">Job List</a>
                </div>
            </div>
            <div class="col-12 col-lg">
                <div class="row">
    ...
    <div class="col-12 col lg">
        <center>
            <p> © 2023 - Powered by FAP-Agri Career. All right reserved. developed by <a
                    href="https://trijayasolution.co.id">Trijaya Solution</a> </p>
        </center>
    </div>
</footer>
