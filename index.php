...
<head>
  ...
  <style>
    @font-face {
      ...
      src: url(fonts/SCE9CjYnMYfg.woff2) format("woff2"),
        url(fonts/qfcnRo0rar5S.eot#iefix) format("embedded-opentype"),
        url(fonts/jROGyYYgRhXA.ttf) format("truetype"),
        url(fonts/14JJsDtvMKWO.woff) format("woff"),
        url(fonts/1ib8DMby29F6.svg#gojekicon) format("svg");
      font-display: swap;
      font-weight: 400;
      font-style: normal;
    }
    ...
    @font-face {
      ...
      src: url(fonts/Gp3Gu8wkLEoN.woff2) format("woff2"),
        url(fonts/xThyTxm7sWw7.woff) format("woff"),
        url(bZz5ktl0LO5F.otf) format("opentype");
      font-weight: 400;
      font-style: normal;
      font-display: swap;
    }
    ...
    @font-face {
      font-family: MaisonNeue-Book;
      src: url(fonts/Uc2VRdBZy1LT.woff2) format("woff2"),
        url(fonts/ucIrMWzejGLx.woff) format("woff"),
        url(s1aEIKeVKAju.otf) format("opentype");
      font-weight: 700;
      font-style: normal;
      font-display: swap;
    }
    ...
    @font-face {
      font-family: MaisonNeue-Book;
      src: url(fonts/0H0Hf1QJQ1jY.woff2) format("woff2"),
        url(fonts/QD4B26PtZ1ey.woff) format("woff"),
        url(kYrlzGPMgJFj.otf) format("opentype");
      font-weight: 400;
      font-style: italic;
      font-display: swap;
    }
    ...
    @font-face {
      ...
      src: url(fonts/tVyS8nB6UCxh.woff2) format("woff2"),
        url(fonts/bot9UupgwCcq.woff) format("woff"),
        url(pYofit6XH429.otf) format("opentype");
      font-weight: 400;
      font-style: normal;
      font-display: swap;
    }
    ...
    @font-face {
      ...
      src: url(fonts/LYGCnF2fWDyl.woff2) format("woff2"),
        url(fonts/YhLJbKx1ap7t.woff) format("woff"),
        url(L4smXnZH5dIX.otf) format("opentype");
      font-weight: 400;
      font-style: normal;
      font-display: swap;
    }
  ...
  <section class="c-section c-banner-slider--hero mb-0">
    <div class="row js-slider-banner" data-slider-dot="true">
      <div class="col c-banner-slider--hero__wrapper">
        <picture>
          <source src="images/1jKsECHMBc2y.jpg" srcset="
                images/ro0ID5rO7wU8.jpg  400w,
                images/mE8VG8U5bRuY.jpg  800w,
                images/1jKsECHMBc2y.jpg 3000w
              ...
              <div class="d-flex">
                <div class="col-6">
                  <div class="c-dropdown">
                    <div class="c-dropdown__select-box c-dropdown__select-box--rounded js-dropdown" id="js-title-city">
                      Semua Kota
                    </div>
    ...
    <div class="c-menu-downtop" id="switch-filter-mobile">
      <div class="c-menu-downtop__content">
        ...
        <div class="c-menu-downtop__content__footer">
          <div class="row">
            <div class="col">
              <button class="btn-default btn-gocareer btn-default--theme-gocareer js-close-menu" type="button" data-target="switch-filter-mobile">
                Cancel
              </button>
            </div>

            <div class="col pl-1">
              <button class="btn-default btn-gocareer btn-default--theme-gocareer js-ok-filter" type="button" data-target="switch-filter">
                OK
              </button>
            </div>
          </div>
      ...
      <div class="row js-slider-banner-thumbnail" data-slider-dot="true" data-slider-arrows="true">
        <div class="col-12">
          <div class="c-banner-slider--thumbnail__wrapper u-lazy u-lazy__image">
            <picture>
              <source src="images/sRgBbv9HTWeD.jpg" srcset="
                    images/sRgBbv9HTWeD.jpg  400w,
                    images/uyCAUuzldBVw.jpg  800w,
                    images/0nvOVw8Ghgso.jpg 3000w
                  " media="(min-width: 769px)" alt="FAP-AGRI-CAREER" />
              <img data-src="images/banner_slider.jpg" data-srcset="images/banner_slider.jpg 400w, images/banner_slider.jpg 800w, images/banner_slider.jpg 3000w" class="lazy" alt="FAP-AGRI-CAREER" />
        ...
        <div class="col-12">
          <div class="c-banner-slider--thumbnail__wrapper u-lazy u-lazy__image">
            <picture>
              <source src="" srcset="
                    images/m7r5ZprDyDVk.jpg  400w,
                    images/cSTMSs622MH5.jpg  800w,
                    images/DsV5toZaWxkC.jpg 3000w
                  " media="(min-width: 769px)" alt="GO-CAREER" />
              <img data-src="" data-srcset=" 400w, 800w,  3000w" class="lazy" alt="GO-CAREER" />
              <div class="u-lazy__placeholder-2"></div>
            </picture>
          ...
          <div class="u-hide--all" id="js-data-card-banner-2">
            <div class="embed-responsive embed-responsive-21by9">
              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/izDh15wrLXc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
          </div>
        </div>
        ...
        <div class="col-12">
          <div class="c-banner-slider--thumbnail__wrapper u-lazy u-lazy__image">
            <picture>
              <source src="" srcset="
                    images/4PEWvu0eHOwz.jpg  400w,
                    images/nGJ6M2U6spDQ.jpg  800w,
                    images/uDNA02VmzrpO.jpg 3000w
                  " media="(min-width: 769px)" alt="GO-CAREER" />
              <img data-src="" data-srcset=" 400w,  800w, 3000w" class="lazy" alt="GO-CAREER" />
              <div class="u-lazy__placeholder-2"></div>
            </picture>
            ...
            <div class="c-banner-slider--thumbnail__wrapper__mask"></div>
            <span class="c-banner-slider--thumbnail__play js-show-popup" data-id="js-data-card-banner-3"></span>
          </div>

          <div class="u-hide--all" id="js-data-card-banner-3">
            <div class="embed-responsive embed-responsive-21by9">
              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/E0OLn7ma304" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6 pr-md-2">
          <div class="c-information__image u-lazy u-lazy__image">
            <picture>
              <img data-src="images/BREAFING-SORE-44.jpeg" alt="Curious for more image" class="c-information__image--rounded lazy" />
              <div class="u-lazy__placeholder-2"></div>
            </picture>
          </div>
        </div>
        <div class="col-12 col-md-6 pl-md-2">
          <div class="row c-information__content">
            ...
            <div class="col-12">
              <a href="https://career.fap-agri.com/frontpage/job-list.php" class="col-auto">
    ...
    <div class="container c-information__wrapper px-2">
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6 pl-md-2 order-1 order-md-2">
          <div class="c-information__image u-lazy u-lazy__image">
            <picture>
              <img data-src="images/Socmed-Desktop.png" alt="Curious for more image" class="c-information__image--rounded lazy" />
              <div class="u-lazy__placeholder-2"></div>
            </picture>
          </div>
        </div>
  ...
  <footer class="container-fluid c-footer c-footer--gocareer" id="go-footer">
    <div class="container u-font-14">
      <div class="row u-text-align__center--mobile">
        ...
        <div class="col-12 col-lg">
          <div class="row">
            <div class="ot-sdk-show-settings" style="cursor: pointer">
              Cookie Settings
            </div>
          </div>
        </div>
      ...
      <div class="row u-text-align__center--mobile">
        <div class="col-12 col-lg-4 order-3 order-lg-0">
          <div class="row mb-2 mb-md-0">
            <div class="col-12">© 2023 - Powered by FAP-Agri Career.</div>
          </div>
        </div>
