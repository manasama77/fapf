...
$path_foto_filename = basename(time() . '-FOTO-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_foto"]["name"], PATHINFO_EXTENSION));
$path_foto_file = $target_dir . $path_foto_filename;

$path_ktp_filename = basename(time() . '-KTP-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_ktp"]["name"], PATHINFO_EXTENSION));
$path_ktp_file = $target_dir . $path_ktp_filename;

$path_akta_kelahiran_filename = basename(time() . '-AKTA KELAHIRAN-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_akta_kelahiran"]["name"], PATHINFO_EXTENSION));
$path_akta_kelahiran_file = $target_dir . $path_akta_kelahiran_filename;

$path_ijasah_filename = basename(time() . '-IJASAH-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_ijasah"]["name"], PATHINFO_EXTENSION));
$path_ijasah_file = $target_dir . $path_ijasah_filename;

$path_transkrip_nilai_filename = basename(time() . '-TRANSKRIP NILAI-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_transkrip_nilai"]["name"], PATHINFO_EXTENSION));
$path_transkrip_nilai_file = $target_dir . $path_transkrip_nilai_filename;

$path_setifikat_pelatihan_filename = basename(time() . '-SERTIFIKAT PELATIHAN-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_setifikat_pelatihan"]["name"], PATHINFO_EXTENSION));
$path_setifikat_pelatihan_file = $target_dir . $path_setifikat_pelatihan_filename;

$path_surat_pengalaman_kerja_filename = basename(time() . '-SURAT PENGALAMAN KERJA-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_surat_pengalaman_kerja"]["name"], PATHINFO_EXTENSION));
$path_surat_pengalaman_kerja_file = $target_dir . $path_surat_pengalaman_kerja_filename;

$path_slip_gaji_filename = basename(time() . '-SLIP GAJI-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_slip_gaji"]["name"], PATHINFO_EXTENSION));
$path_slip_gaji_file = $target_dir . $path_slip_gaji_filename;

$path_npwp_filename = basename(time() . '-NPWP-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_npwp"]["name"], PATHINFO_EXTENSION));
$path_npwp_file = $target_dir . $path_npwp_filename;

$path_bpjs_tk_filename = basename(time() . '-BPJS TK-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_bpjs_tk"]["name"], PATHINFO_EXTENSION));
$path_bpjs_tk_file = $target_dir . $path_bpjs_tk_filename;

$path_bpjs_kesehatan_filename = basename(time() . '-BPJS KESEHATAN-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_bpjs_kesehatan"]["name"], PATHINFO_EXTENSION));
$path_bpjs_kesehatan_file = $target_dir . $path_bpjs_kesehatan_filename;

$path_buku_tabungan_filename = basename(time() . '-BUKU TABUNGAN-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_buku_tabungan"]["name"], PATHINFO_EXTENSION));
$path_buku_tabungan_file = $target_dir . $path_buku_tabungan_filename;

$path_buku_nikah_filename = basename(time() . '-BUKU NIKAH-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_buku_nikah"]["name"], PATHINFO_EXTENSION));
$path_buku_nikah_file = $target_dir . $path_buku_nikah_filename;

$path_sertifikat_vaksin_filename = basename(time() . '-SERTIFIKAT VAKSIN-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_sertifikat_vaksin"]["name"], PATHINFO_EXTENSION));
$path_sertifikat_vaksin_file = $target_dir . $path_sertifikat_vaksin_filename;

$path_skck_filename = basename(time() . '-SKCK-' . $_SESSION['nama_lengkap'] . '.' . pathinfo($_FILES["path_skck"]["name"], PATHINFO_EXTENSION));
